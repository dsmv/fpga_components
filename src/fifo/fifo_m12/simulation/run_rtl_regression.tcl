...
set glbl_log "src/fifo/fifo_m12/simulation/log/global_tc_summary.log"
		 	
cd $dsn		

set    glbl_log_file [open $glbl_log w]
puts  $glbl_log_file "Global fifo_12 TC log:"
close $glbl_log_file
...
proc run_test { tc_name tc_time } {
 set log_name  "src/fifo/fifo_m12/simulation/log/"
...
run_test "tc_00_01"  "3 ms"
run_test "tc_00_02"  "3 ms"
